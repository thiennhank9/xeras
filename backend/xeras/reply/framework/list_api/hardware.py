hardware_api = {
    'hoi_sac_may_chau': {
        'positive_answer': [
            '''Chào bạn, 
            hiện tại sản phẩm sử dụng sạc {phone_charge_type} bạn nhé,
    ...
    'hoi_thoi_gian_sac': {
        'positive_answer': [
            '''Chào bạn, 
            thời gian sạc khoảng {charge_time} tiếng bạn nhé,
            mong sớm nhận được phản hồi của bạn.'''
        ],
        'negative_answer': [
            '''Chào bạn,
    ...
    'hoi_thoi_gian_su_dung': {
        'positive_answer': [
            '''Chào bạn, 
            thời gian sử dụng khoảng {time_using} tiếng bạn nhé,
            mong sớm nhận được phản hồi của bạn.'''
        ],
        'negative_answer': [
            '''Chào bạn,
    ...
    'hoi_ve_chip': {
        'positive_answer': [
            '''Chào bạn, 
            sản phẩm sử dụng chip {chip_info} bạn nhé,
            mong sớm nhận được phản hồi của bạn.'''
        ],
        'negative_answer': [
            '''Chào bạn,
    ...
    'hoi_ve_camera_truoc': {
        'positive_answer': [
            '''Chào bạn, 
            sản phẩm sử dụng camera trước {camera_phone_info} pixel bạn nhé,
            mong sớm nhận được phản hồi của bạn.'''
        ],
        'negative_answer': [
            '''Chào bạn,
    ...
    'hoi_ve_vo_dien_thoai': {
        'positive_answer': [
            '''Chào bạn, 
            sản phẩm sử dụng vỏ {case_info} bạn nhé,
            mong sớm nhận được phản hồi của bạn.'''
        ],
        'negative_answer': [
            '''Chào bạn,
    ...
    'hoi_man_hinh_nhieu_inch': {
        'positive_answer': [
            '''Chào bạn, 
            sản phẩm có màn hình {screen_inch} bạn nhé,
            mong sớm nhận được phản hồi của bạn.'''
        ],
        'negative_answer': [
            '''Chào bạn,
    ...
    'hoi_ve_loai_man_hinh': {
        'positive_answer': [
            '''Chào bạn, 
            sản phẩm có màn hình {screen_type} bạn nhé,
            mong sớm nhận được phản hồi của bạn.'''
        ],
        'negative_answer': [
            '''Chào bạn,
    ...
    'hoi_co_ho_tro_4G': {
        'positive_answer': [
            '''Chào bạn, 
            sản phẩm có hỗ trợ bạn nhé,
            mong sớm nhận được phản hồi của bạn.'''
        ],
        'negative_answer': [
            '''Chào bạn,
            sản phẩm không hỗ trợ bạn nhé,
            bạn hãy để lại thông tin liên hệ để nhận được thông báo sớm nhất nhé!!!'''
        ],
    ...
    'hoi_co_bao_nhieu_sim': {
        'positive_answer': [
            '''Chào bạn, 
            sản phẩm có hỗ trợ {number_sim_support} sim bạn nhé,
            mong sớm nhận được phản hồi của bạn.'''
        ],
        'negative_answer': [
            '''Chào bạn,
    ...
    'hoi_ve_loai_sim': {
        'positive_answer': [
            '''Chào bạn, 
            sản phẩm có sử dụng loại sim {sim_type} bạn nhé,
            mong sớm nhận được phản hồi của bạn.'''
        ],
        'negative_answer': [
            '''Chào bạn,
    ...
    'hoi_co_chong_nuoc_khong': {
        'positive_answer': [
            '''Chào bạn, 
            sản phẩm có chống nước bạn nhé,
            mong sớm nhận được phản hồi của bạn.'''
        ],
        'negative_answer': [
            '''Chào bạn,
            sản phẩm không chống nước bạn nhé,
            bạn hãy để lại thông tin liên hệ để nhận được thông báo sớm nhất nhé!!!'''
        ],
        'answer_key': 'sim_type'
    }
