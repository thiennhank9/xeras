...
X, y = keras_text_classifier.load_data(['data/sentiment/samples/positive.txt',
                                       ...
                                       'data/sentiment/samples/caimoi.txt'],
...
label_dict = {0: 'hỏi thời tiết', 1: 'hỏi giá', 2: 'chê mắc'}
test_sentences = ['thời tiết mai sao', 'mai có mưa không', 'điện thoại này bao tiền', 'giá nhiêu em gái mưa', 'mắc']
