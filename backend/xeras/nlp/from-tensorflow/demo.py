...
label_dict = {0: 'hỏi thời tiết', 1: 'hỏi giá'}
test_sentences = ['thời tiết mai sao', 'mai có mưa không', 'điện thoại này bao tiền', 'giá nhiêu em gái mưa', 'giá cao vãi mẹ mày mua']
