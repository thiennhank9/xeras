...
class TextClassificationPredict(object):
    ...
    def get_train_data(self):
        ...
        train_data.append({"feature": u"Còn mẫu điện thoại này ở TPHCM ko bé", "target": "hoi_so_luong"})
        train_data.append({"feature": u"Còn hàng không", "target": "hoi_so_luong"})
        df_train = pd.DataFrame(train_data)

        #  test data
        test_data = []
        # test_data.append({"feature": u"Nóng quá, liệu mưa không em ơi?", "target": "hoi_so_luong"})
        test_data.append({"feature": u"Hi em, Nay trời đẹp không em", "target": "xxx"})
