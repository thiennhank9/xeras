 ...
 *
 * @FieldFormatter(
 *   id = "jango_cms_project_image_slider",
 *   label = @Translation("Jango CMS: Project Image Slider"),
 *   field_types = {
 *     "image",
 *   }
 * )
 */
class NDJangoProjectImageSliderFormatter extends ImageFormatter implements ContainerFactoryPluginInterface {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    $theme_array = [
      '#theme' => 'jango_cms_project_image_slider_formatter',
      '#images' => $images,
    ];
