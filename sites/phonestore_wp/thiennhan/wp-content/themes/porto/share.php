...
if ($porto_settings['share-whatsapp']) :
    ?><a href="whatsapp://send?text=<?php echo $title ?> - <?php echo $permalink ?>" <?php echo $extra_attr ?> title="<?php echo __('WhatsApp', 'porto') ?>" class="share-whatsapp" style="display:none"><?php echo __('WhatsApp', 'porto') ?></a><?php
endif;
